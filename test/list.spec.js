...
describe('Linked List', function() {
    ...
    describe('iterator functionality', function() {
        ...
        it('iterator currentNode is null when first instantiated', function() {
    ...
    describe('insert functionality', function() {
        it(
            'sets the head node equal to the tail node when first item ' + 'is inserted',
            function() {
    ...
    describe('find functionality', function() {
        ...
        it('returns the index of node containing the provided data', function() {
            populateList(list, 3);
        ...
        it(
            'returns -1 for the index of node with the given data if the' + 'node does not exist',
            function() {
                populateList(list, 3);
        ...
        it('returns -1 when findAt() is called w/ index > than list size', function() {
            var node = list.findAt(0);
            expect(node).to.not.be.an('object');
            expect(node).to.equal(-1);
        });
